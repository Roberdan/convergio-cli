...
void error_setf(ConvergioError* err, ErrorDomain domain, ConvergioErrorCode code, const char* fmt,
                ...) {
    if (!err || !fmt)
        return;
    err->domain = domain;
...
void error_from_workflow(ConvergioError* err, int workflow_error_type, const char* message) {
    if (!err)
        return;
...
void error_from_provider(ConvergioError* err, int provider_error, const char* message,
...
const char* error_domain_name(ErrorDomain domain) {
    switch (domain) {
    case ERROR_DOMAIN_NONE:
        return "none";
    case ERROR_DOMAIN_SYSTEM:
        return "system";
    case ERROR_DOMAIN_WORKFLOW:
        return "workflow";
    case ERROR_DOMAIN_PROVIDER:
        return "provider";
    case ERROR_DOMAIN_MLX:
        return "mlx";
    case ERROR_DOMAIN_NETWORK:
        return "network";
    case ERROR_DOMAIN_DATABASE:
        return "database";
    case ERROR_DOMAIN_AUTH:
        return "auth";
    case ERROR_DOMAIN_CONFIG:
        return "config";
    default:
        return "unknown";
    }
...
const char* error_code_name(ConvergioErrorCode code) {
    ...
    case CONVERGIO_OK:
        return "OK";
    case CONVERGIO_ERR_UNKNOWN:
        return "UNKNOWN";
    case CONVERGIO_ERR_INVALID_ARGUMENT:
        return "INVALID_ARGUMENT";
    case CONVERGIO_ERR_OUT_OF_MEMORY:
        return "OUT_OF_MEMORY";
    case CONVERGIO_ERR_NOT_INITIALIZED:
        return "NOT_INITIALIZED";
    case CONVERGIO_ERR_ALREADY_INITIALIZED:
        return "ALREADY_INITIALIZED";
    case CONVERGIO_ERR_NOT_FOUND:
        return "NOT_FOUND";
    case CONVERGIO_ERR_ALREADY_EXISTS:
        return "ALREADY_EXISTS";
    case CONVERGIO_ERR_PERMISSION_DENIED:
        return "PERMISSION_DENIED";
    case CONVERGIO_ERR_TIMEOUT:
        return "TIMEOUT";
    case CONVERGIO_ERR_CANCELLED:
        return "CANCELLED";
    case CONVERGIO_ERR_NETWORK:
        return "NETWORK";
    case CONVERGIO_ERR_CONNECTION_FAILED:
        return "CONNECTION_FAILED";
    case CONVERGIO_ERR_DNS_FAILED:
        return "DNS_FAILED";
    case CONVERGIO_ERR_SSL_ERROR:
        return "SSL_ERROR";
    case CONVERGIO_ERR_RATE_LIMITED:
        return "RATE_LIMITED";
    case CONVERGIO_ERR_CREDIT_EXHAUSTED:
        return "CREDIT_EXHAUSTED";
    case CONVERGIO_ERR_PROVIDER_DOWN:
        return "PROVIDER_DOWN";
    case CONVERGIO_ERR_INVALID_RESPONSE:
        return "INVALID_RESPONSE";
    case CONVERGIO_ERR_MODEL_NOT_FOUND:
        return "MODEL_NOT_FOUND";
    case CONVERGIO_ERR_AUTH_FAILED:
        return "AUTH_FAILED";
    case CONVERGIO_ERR_TOKEN_EXPIRED:
        return "TOKEN_EXPIRED";
    case CONVERGIO_ERR_API_KEY_INVALID:
        return "API_KEY_INVALID";
    case CONVERGIO_ERR_FILE_NOT_FOUND:
        return "FILE_NOT_FOUND";
    case CONVERGIO_ERR_FILE_READ:
        return "FILE_READ";
    case CONVERGIO_ERR_FILE_WRITE:
        return "FILE_WRITE";
    case CONVERGIO_ERR_PATH_TOO_LONG:
        return "PATH_TOO_LONG";
    case CONVERGIO_ERR_DB_OPEN:
        return "DB_OPEN";
    case CONVERGIO_ERR_DB_QUERY:
        return "DB_QUERY";
    case CONVERGIO_ERR_DB_CONSTRAINT:
...
const char* error_to_string(const ConvergioError* err, char* buf, size_t buf_size) {
    ...
    snprintf(buf, buf_size, "[%s:%s] %s%s", error_domain_name(err->domain),
             error_code_name(err->code), err->message, err->is_retryable ? " (retryable)" : "");
