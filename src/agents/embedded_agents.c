...
// tester-e2e-quality-assurance.md
static const char agent_tester_e2e_quality_assurance_md[] =
    "---\n"
...
const EmbeddedAgent EMBEDDED_AGENTS[] = {
    ...
    {"tester-e2e-quality-assurance.md", agent_tester_e2e_quality_assurance_md, sizeof(agent_tester_e2e_quality_assurance_md) - 1},
