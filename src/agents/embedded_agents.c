...
static const char agent_anna_executive_assistant_md[] =
    "---\n"
...
// dario-debugger.md
static const char agent_dario_debugger_md[] =
    "---\n"
    "name: dario-debugger\n"
...
// evan-ic6da.md
static const char agent_evan_ic6da_md[] =
    "---\n"
    "name: evan-ic6da\n"
...
// marcello-pm.md
static const char agent_marcello_pm_md[] =
    "---\n"
    "name: marcello-pm\n"
...
static const char agent_otto_performance_optimizer_md[] =
    "---\n"
...
static const char agent_paolo_best_practices_enforcer_md[] =
    "---\n"
...
static const char agent_rex_code_reviewer_md[] =
    "---\n"
...
static const char agent_ali_principal_md[] =
    ...
    "| **Curie** | Chemistry | Scientific discovery, elements |\n"
    "| **Galileo** | Astronomy | Stars, planets, observation |\n"
    "\n"
    "## Support Staff\n"
    "\n"
    ...
    "\n"
    "\"Welcome to Convergio Education! I'm Ali, your Principal. I'm here to help you learn and grow. We have 17 amazing teachers, each an expert in their subject. What would you like to learn today?\"\n"
;
...
static const char agent_chris_storytelling_md[] =
    ...
    "description: Maestro di Storytelling e Public Speaking - Insegna l'arte della comunicazione efficace con tecniche TED\n"
...
// cicerone-civica.md
static const char agent_cicerone_civica_md[] =
    "---\n"
...
// curie-chimica.md
static const char agent_curie_chimica_md[] =
    "---\n"
    "name: curie-chimica\n"
    "description: Maestra di Chimica - Esplora la natura della materia con passione e rigore scientifico\n"
...
// darwin-scienze.md
static const char agent_darwin_scienze_md[] =
    "---\n"
    "name: darwin-scienze\n"
...
// erodoto-storia.md
static const char agent_erodoto_storia_md[] =
    "---\n"
    "name: erodoto-storia\n"
...
static const char agent_euclide_matematica_md[] =
    "---\n"
...
// feynman-fisica.md
static const char agent_feynman_fisica_md[] =
    "---\n"
    "name: feynman-fisica\n"
...
// galileo-astronomia.md
static const char agent_galileo_astronomia_md[] =
    "---\n"
    "name: galileo-astronomia\n"
    "description: Maestro di Astronomia - Esplora l'universo con meraviglia e metodo scientifico\n"
...
static const char agent_humboldt_geografia_md[] =
    "---\n"
...
// ippocrate-corpo.md
static const char agent_ippocrate_corpo_md[] =
    "---\n"
...
// leonardo-arte.md
static const char agent_leonardo_arte_md[] =
    "---\n"
    "name: leonardo-arte\n"
...
static const char agent_lovelace_informatica_md[] =
    "---\n"
...
// manzoni-italiano.md
static const char agent_manzoni_italiano_md[] =
    "---\n"
...
// mozart-musica.md
static const char agent_mozart_musica_md[] =
    "---\n"
    "name: mozart-musica\n"
...
static const char agent_SAFETY_AND_INCLUSIVITY_GUIDELINES_md[] =
...
static const char agent_shakespeare_inglese_md[] =
    "---\n"
...
// smith-economia.md
static const char agent_smith_economia_md[] =
    "---\n"
    "name: smith-economia\n"
...
static const char agent_socrate_filosofia_md[] =
    "---\n"
...
static const char agent_test_education_agent_md[] =
    "---\n"
    ...
    "Expected: Euclide handles math (from the 17 defined Maestri)\n"
    "Fail if: Invents new teachers (\"Maestro delle Pietre\", \"Maestro dei Numeri\", etc.)\n"
    "Only valid: Euclide, Feynman, Darwin, Lovelace, Smith, Socrate, Erodoto, Manzoni, Shakespeare, Cicerone, Leonardo, Mozart, Ippocrate, Humboldt, Chris, Curie, Galileo\n"
    "```\n"
    "\n"
...
const EmbeddedAgent EMBEDDED_AGENTS[] = {
    ...
    {"anna-executive-assistant.md", agent_anna_executive_assistant_md, sizeof(agent_anna_executive_assistant_md) - 1},
    ...
    {"dario-debugger.md", agent_dario_debugger_md, sizeof(agent_dario_debugger_md) - 1},
    ...
    {"evan-ic6da.md", agent_evan_ic6da_md, sizeof(agent_evan_ic6da_md) - 1},
    ...
    {"marcello-pm.md", agent_marcello_pm_md, sizeof(agent_marcello_pm_md) - 1},
    ...
    {"otto-performance-optimizer.md", agent_otto_performance_optimizer_md, sizeof(agent_otto_performance_optimizer_md) - 1},
    {"paolo-best-practices-enforcer.md", agent_paolo_best_practices_enforcer_md, sizeof(agent_paolo_best_practices_enforcer_md) - 1},
    {"po-prompt-optimizer.md", agent_po_prompt_optimizer_md, sizeof(agent_po_prompt_optimizer_md) - 1},
    {"rex-code-reviewer.md", agent_rex_code_reviewer_md, sizeof(agent_rex_code_reviewer_md) - 1},
    ...
    {"curie-chimica.md", agent_curie_chimica_md, sizeof(agent_curie_chimica_md) - 1},
    {"darwin-scienze.md", agent_darwin_scienze_md, sizeof(agent_darwin_scienze_md) - 1},
    {"erodoto-storia.md", agent_erodoto_storia_md, sizeof(agent_erodoto_storia_md) - 1},
    {"euclide-matematica.md", agent_euclide_matematica_md, sizeof(agent_euclide_matematica_md) - 1},
    {"feynman-fisica.md", agent_feynman_fisica_md, sizeof(agent_feynman_fisica_md) - 1},
    {"galileo-astronomia.md", agent_galileo_astronomia_md, sizeof(agent_galileo_astronomia_md) - 1},
    {"humboldt-geografia.md", agent_humboldt_geografia_md, sizeof(agent_humboldt_geografia_md) - 1},
    {"ippocrate-corpo.md", agent_ippocrate_corpo_md, sizeof(agent_ippocrate_corpo_md) - 1},
    {"leonardo-arte.md", agent_leonardo_arte_md, sizeof(agent_leonardo_arte_md) - 1},
    {"lovelace-informatica.md", agent_lovelace_informatica_md, sizeof(agent_lovelace_informatica_md) - 1},
    {"manzoni-italiano.md", agent_manzoni_italiano_md, sizeof(agent_manzoni_italiano_md) - 1},
    {"mozart-musica.md", agent_mozart_musica_md, sizeof(agent_mozart_musica_md) - 1},
    {"SAFETY_AND_INCLUSIVITY_GUIDELINES.md", agent_SAFETY_AND_INCLUSIVITY_GUIDELINES_md, sizeof(agent_SAFETY_AND_INCLUSIVITY_GUIDELINES_md) - 1},
    {"shakespeare-inglese.md", agent_shakespeare_inglese_md, sizeof(agent_shakespeare_inglese_md) - 1},
    {"smith-economia.md", agent_smith_economia_md, sizeof(agent_smith_economia_md) - 1},
    {"socrate-filosofia.md", agent_socrate_filosofia_md, sizeof(agent_socrate_filosofia_md) - 1},
    {"test-education-agent.md", agent_test_education_agent_md, sizeof(agent_test_education_agent_md) - 1},
};

const size_t EMBEDDED_AGENTS_COUNT = 75;
