 ...
 */
uint64_t workflow_checkpoint_incremental(Workflow* wf, uint64_t previous_checkpoint_id,
 ...
 */
int workflow_get_changed_state_entries(const Workflow* wf, time_t last_checkpoint_time,
                                       char*** changed_keys, size_t* changed_count) {
 ...
 */
__attribute__((unused)) static Checkpoint* checkpoint_pool_alloc(void) {
 ...
 */
__attribute__((unused)) static void checkpoint_pool_free(Checkpoint* checkpoint) {
    if (!checkpoint) {
        return;
    }
 ...
 */
__attribute__((unused)) static char* serialize_workflow_state_optimized(
