...
// ============================================================================
// WORKFLOW INTEGRATION (v2 - Workflow-based orchestrator functions)
// ============================================================================
 ...
 * It provides better state management, checkpointing, and error recovery.
 * 
 * @deprecated Use orchestrator_parallel_analyze() for backward compatibility.
 * New code should use workflow patterns directly via pattern_create_parallel_analysis().
 */
 ...
 * 
 * @deprecated Use orch_plan_create() for backward compatibility.
 * New code should use workflow patterns directly via pattern_create_sequential_planning().
 */
 ...
 * @note Caller must free() the returned string
 * 
 * @deprecated New code should use workflow patterns directly via pattern_create_review_refine_loop().
 */
